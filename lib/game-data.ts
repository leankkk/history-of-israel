...
,
  ...
  { pregunta:"¿Cómo se llama el Parlamento israelí?", opciones:["Majlis","Duma","Knéset","Senado"], correcta:2, bonus:40, penalidad:20 },
  { pregunta:"¿Qué significa 'Mossad' en hebreo?", opciones:["Espía","Instituto","Escudo","Defensa"], correcta:1, bonus:50, penalidad:25 },
  { pregunta:"¿En qué ciudad nació David Ben-Gurión?", opciones:["Varsovia","Plonsk","Tel Aviv","Odessa"], correcta:1, bonus:60, penalidad:30 },
  { pregunta:"¿Cuántos países árabes atacaron a Israel en la Guerra de Independencia de 1948?", opciones:["3","4","5","6"], correcta:2, bonus:55, penalidad:25 },
  { pregunta:"¿Qué ciudad fue capital de Israel antes que Jerusalén fuera reconocida internacionalmente?", opciones:["Haifa","Tel Aviv","Beersheba","Jaffa"], correcta:1, bonus:50, penalidad:25 },
  { pregunta:"¿Qué país fue el primero en reconocer al Estado de Israel en 1948?", opciones:["Reino Unido","Francia","Estados Unidos","Unión Soviética"], correcta:2, bonus:60, penalidad:30 },
  { pregunta:"¿Cómo se llama el Mar Interior de Israel, el más salado del mundo?", opciones:["Mar de Galilea","Mar Rojo","Mar Muerto","Mar Mediterráneo"], correcta:2, bonus:40, penalidad:20 },
  { pregunta:"¿Quién escribió 'El Estado Judío' (Der Judenstaat), libro fundacional del sionismo?", opciones:["Chaim Weizmann","David Ben-Gurión","Theodor Herzl","Max Nordau"], correcta:2, bonus:65, penalidad:30 },
  { pregunta:"¿En qué año Israel capturó Jerusalén Este en la Guerra de los Seis Días?", opciones:["1956","1967","1973","1982"], correcta:1, bonus:55, penalidad:25 },
  { pregunta:"¿Qué tecnología israelí inventó la empresa Netafim?", opciones:["Paneles solares","Riego por goteo","Desalinización","GPS agrícola"], correcta:1, bonus:50, penalidad:25 },
  { pregunta:"¿Cómo se llama el acuerdo de paz entre Israel y Jordania firmado en 1994?", opciones:["Acuerdo de Wadi Araba","Acuerdo de Oslo","Acuerdo de Camp David","Acuerdo de Madrid"], correcta:0, bonus:60, penalidad:30 },
  { pregunta:"¿Qué ciudad israelí tiene el mayor puerto del país?", opciones:["Tel Aviv","Haifa","Ashdod","Eilat"], correcta:1, bonus:45, penalidad:20 },
  { pregunta:"¿En qué año se creó la Fuerza Aérea Israelí (Heyl Ha'Avir)?", opciones:["1946","1948","1950","1952"], correcta:1, bonus:55, penalidad:25 },
  { pregunta:"¿Qué significa 'Aliyá' literalmente en hebreo?", opciones:["Retorno","Ascenso","Llegada","Viaje"], correcta:1, bonus:45, penalidad:20 },
  { pregunta:"¿En qué desierto está ubicada la ciudad de Beersheba?", opciones:["Sinaí","Judea","Néguev","Arábigo"], correcta:2, bonus:50, penalidad:25 },
  { pregunta:"¿Qué israelí ganó el Premio Nobel de Literatura en 1966?", opciones:["Amos Oz","S.Y. Agnon","A.B. Yehoshua","David Grossman"], correcta:1, bonus:65, penalidad:30 },
  { pregunta:"¿Cuántos premios Nobel han ganado ciudadanos israelíes hasta 2020?", opciones:["4","8","12","15"], correcta:2, bonus:60, penalidad:25 },
  { pregunta:"¿Qué operación militar israelí destruyó el reactor nuclear iraquí en 1981?", opciones:["Operación Ira de Dios","Operación Entebbe","Operación Ópera","Operación Trueno"], correcta:2, bonus:60, penalidad:30 },
  { pregunta:"¿Cuál es el río más largo de Israel?", opciones:["Jordán","Yarkon","Kishon","Litani"], correcta:0, bonus:50, penalidad:25 },
  { pregunta:"¿En qué año Israel lanzó su primer satélite espacial, el Ofeq-1?", opciones:["1984","1988","1992","1996"], correcta:1, bonus:65, penalidad:30 },
  { pregunta:"¿Qué empresa israelí desarrolló el sistema antivirus PC-cillin en los años 90?", opciones:["Check Point","Aladdin","Trend Micro Israel","CyberArk"], correcta:0, bonus:60, penalidad:25 },
  { pregunta:"¿Cómo se llama el valle fértil al norte de Israel entre el Mar de Galilea y el Mediterráneo?", opciones:["Valle del Jordán","Valle de Jezreel","Valle del Néguev","Valle de Hula"], correcta:1, bonus:55, penalidad:25 },
  { pregunta:"¿Qué ciudad es considerada la 'Capital del Desierto' israelí?", opciones:["Dimona","Eilat","Beersheba","Mitzpe Ramon"], correcta:2, bonus:50, penalidad:25 },
  { pregunta:"¿En qué año Israel realizó la Operación Salomón para traer judíos etíopes?", opciones:["1984","1988","1991","1995"], correcta:2, bonus:60, penalidad:30 },
  { pregunta:"¿Quién fue la primera mujer elegida al Knéset israelí?", opciones:["Golda Meir","Rachel Cohen","Ada Maimon","Dvora Netzer"], correcta:2, bonus:65, penalidad:30 },
  { pregunta:"¿Qué moneda usa Israel actualmente?", opciones:["Libra israelí","Shekel nuevo","Dinar","Lira"], correcta:1, bonus:35, penalidad:15 },
  { pregunta:"¿Cuántos kilómetros tiene la costa mediterránea de Israel aproximadamente?", opciones:["100 km","190 km","280 km","350 km"], correcta:1, bonus:55, penalidad:25 },
  { pregunta:"¿Qué porcentaje del territorio israelí es desierto (Néguev)?", opciones:["30%","45%","60%","75%"], correcta:2, bonus:60, penalidad:25 },
  { pregunta:"¿En qué año se construyó el Muro de los Lamentos originalmente?", opciones:["516 a.C.","37 a.C.","70 d.C.","135 d.C."], correcta:1, bonus:65, penalidad:30 },
  { pregunta:"¿Qué significa 'Tzahal' en hebreo (acrónimo del ejército israelí)?", opciones:["Ejército de Defensa de Israel","Fuerzas Armadas de Sion","Guardia Nacional Israelí","Ejército del Pueblo Hebreo"], correcta:0, bonus:50, penalidad:25 },
  { pregunta:"¿Cuál es el lago de agua dulce más bajo del mundo, ubicado en Israel?", opciones:["Lago Hula","Mar de Galilea","Lago Kinneret","Los dos últimos son el mismo lago"], correcta:3, bonus:65, penalidad:30 },
  { pregunta:"¿En qué año Israel firmó los Acuerdos de Abraham con Emiratos Árabes Unidos?", opciones:["2018","2019","2020","2021"], correcta:2, bonus:55, penalidad:25 },
  { pregunta:"¿Qué startup israelí fundó el servicio de música Spotify? (falsa — ¿cuál SÍ es israelí?)", opciones:["Spotify","Monday.com","Netflix","Uber"], correcta:1, bonus:60, penalidad:25 },
  { pregunta:"¿Quién fue el primer Ministro de Defensa de Israel?", opciones:["Moshe Dayan","David Ben-Gurión","Yigal Allon","Shimon Peres"], correcta:1, bonus:60, penalidad:30 },
  { pregunta:"¿En qué ciudad está el museo Yad Vashem, memorial del Holocausto?", opciones:["Tel Aviv","Haifa","Jerusalén","Beersheba"], correcta:2, bonus:45, penalidad:20 },
  { pregunta:"¿Qué operación israelí rescató a judíos etíopes en 1984?", opciones:["Operación Salomón","Operación Moisés","Operación Exodo","Operación Abraham"], correcta:1, bonus:60, penalidad:30 },
  { pregunta:"¿Cuántos idiomas oficiales tiene Israel?", opciones:["1","2","3","4"], correcta:1, bonus:45, penalidad:20 },
  { pregunta:"¿Qué ciudad costera israelí es conocida como 'La ciudad blanca' por su arquitectura Bauhaus?", opciones:["Haifa","Jaffa","Tel Aviv","Ashdod"], correcta:2, bonus:55, penalidad:25 },
  { pregunta:"¿En qué año se completó el Acueducto Nacional de Israel?", opciones:["1958","1964","1970","1975"], correcta:1, bonus:60, penalidad:30 },
  { pregunta:"¿Qué significa 'Sabra' en el contexto israelí?", opciones:["Un cactus","Judío nacido en Israel","Inmigrante israelí","Colono pionero"], correcta:1, bonus:50, penalidad:25 },
  { pregunta:"¿Cuál es la universidad más antigua de Israel, fundada en 1925?", opciones:["Technion","Universidad de Tel Aviv","Universidad Hebrea de Jerusalén","Universidad Ben-Gurión"], correcta:2, bonus:60, penalidad:30 },
  { pregunta:"¿Qué arma israelí fue descrita como 'el primer uso de armas cibernéticas en la historia' en 2010?", opciones:["Iron Dome","Stuxnet","Pegasus","Arrow"], correcta:1, bonus:70, penalidad:30 },
  { pregunta:"¿En qué año Israel realizó la primera prueba exitosa del sistema Arrow antimisiles?", opciones:["1990","1998","2000","2003"], correcta:1, bonus:65, penalidad:30 },
  { pregunta:"¿Quién fue el primer astronauta israelí en el espacio?", opciones:["Ilan Ramon","Eytan Stibbe","Rona Ramon","Yair Lapid"], correcta:0, bonus:65, penalidad:30 },
  { pregunta:"¿Cuál es el porcentaje aproximado de población árabe en Israel?", opciones:["5%","10%","20%","30%"], correcta:2, bonus:55, penalidad:25 },
  { pregunta:"¿Qué ciudad israelí tiene el mayor número de startups per cápita del mundo?", opciones:["Haifa","Jerusalén","Tel Aviv","Beer Sheva"], correcta:2, bonus:50, penalidad:25 },
  { pregunta:"¿En qué año Israel ganó su primer campeonato europeo de baloncesto (Maccabi Tel Aviv)?", opciones:["1977","1981","1985","1992"], correcta:0, bonus:60, penalidad:30 },
  { pregunta:"¿Cómo se llama el sistema israelí de inteligencia de señales, equivalente a la NSA?", opciones:["Mossad","Shin Bet","Aman","Unidad 8200"], correcta:3, bonus:65, penalidad:30 },
]
